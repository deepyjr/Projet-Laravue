              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Commandes à venir</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">{{nombreDéclenchement}}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Déclenchements sur la semaine</h6>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div v-for="(elem,key) in aVenir" :key="key">
                    <Card :status="elem.status" :date_debut="elem.date_debut" :date_commande="elem.date_commande"/>
                  </div>
